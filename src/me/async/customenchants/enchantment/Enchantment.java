...
import me.async.customenchants.effect.all.NullEffect;
import me.async.customenchants.effect.armour.GlowingEffect;
import me.async.customenchants.effect.armour.HazyEffect;
import me.async.customenchants.effect.armour.IncombustibleEffect;
import me.async.customenchants.effect.armour.NourishingEffect;
import me.async.customenchants.effect.armour.PlethoricEffect;
import me.async.customenchants.effect.armour.PneumaticEffect;
import me.async.customenchants.effect.armour.ReboundEffect;
import me.async.customenchants.effect.armour.SlipperyEffect;
import me.async.customenchants.effect.armour.SwiftEffect;
import me.async.customenchants.effect.bows.ForceEffect;
import me.async.customenchants.effect.bows.HomingEffect;
import me.async.customenchants.effect.bows.SplinterEffect;
import me.async.customenchants.effect.rods.GrapplingEffect;
import me.async.customenchants.effect.tools.AgileEffect;
import me.async.customenchants.effect.tools.BlindingEffect;
import me.async.customenchants.effect.tools.ChargedEffect;
import me.async.customenchants.effect.tools.CorrodingEffect;
import me.async.customenchants.effect.tools.CripplingEffect;
import me.async.customenchants.effect.tools.DiffusingEffect;
import me.async.customenchants.effect.tools.DireEffect;
import me.async.customenchants.effect.tools.FrozenEffect;
import me.async.customenchants.effect.tools.HookedEffect;
import me.async.customenchants.effect.tools.InquisitiveEffect;
import me.async.customenchants.effect.tools.SerratedEffect;
import me.async.customenchants.effect.tools.SickeningEffect;
import me.async.customenchants.effect.tools.SinkEffect;
import me.async.customenchants.effect.tools.SmeltingEffect;
import me.async.customenchants.effect.tools.TenaciousEffect;
import me.async.customenchants.effect.tools.ToxicEffect;
import me.async.customenchants.effect.tools.UnstableEffect;
import me.async.customenchants.effect.tools.WitheringEffect;
...
public enum Enchantment
{
	...
	GRAPPLING  ("Grappling",   1, EquiptmentType.RODS, EnchantRarity.RARE, new GrapplingEffect())
	;
